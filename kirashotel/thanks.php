...
<title>Hotel Kira´s| Hotel</title>
...
<div class="contact">
  ...
  <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h2>Evaluation</h2>
            <p>Thank you for the evaluation. </p>
...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Casa Strela</h4>
                    <p>Kira’s é uma boutique hotel familiar que funciona na casa onde antes residia a família Spencer, em Mindelo, São Vicente. O nome Kira’s deriva do nome pelo qual o dono da casa era conhecido entre os amigos.</p>
                </div>              
